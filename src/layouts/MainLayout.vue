  ...
  <q-layout view="lHh Lpr lFf">
    <q-header class="bg-dark">
      <q-toolbar>
       ...
       <q-btn flat round>
         <q-avatar>
           <img src="https://i.mydramalist.com/2PrzW_5f.jpg">
      </q-avatar>
      <q-menu>
    ...
    >
      <q-scroll-area class="fit">
        <q-list>
          <q-item class="justify-center text-center q-mb-md q-mt-md">
            <div>
              ...
              <div>Aplikasi Penyewaan Lapangan</div>
            </div>
        </q-item>
        ...
        <q-item clickable active-class="active" v-ripple exact :to="{ name :'DataLapangan'}">
          <q-item-section avatar>
            <q-icon name="article"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Data Lapangan</q-item-label>
          </q-item-section>
        </q-item>
        <q-item clickable active-class="active" :to="{ name: 'InputBarang' }" v-ripple>
          <q-item-section avatar>
            <q-icon name="input"/>
          </q-item-section>
          <q-item-section>
